...
"""Polish a Horizon answer with a LOCAL model server (Ollama, llama.cpp's server, vLLM, LM
...
Run: python3 "HorizonAI Engine/examples/local_model_polish_example.py"
"""
