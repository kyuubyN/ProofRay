...
facts) have been carefully tested in **English and Portuguese** — each cleared its own real test
against text the corresponding mechanism had never seen before. **Chinese support is next**, and
we intend to bring it in as soon as it's ready to meet that same bar, not before. Every language
