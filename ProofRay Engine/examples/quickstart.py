...
"""Quickstart: the minimum code to ask ProofRay a question.

This example calls `ProofRayAnswerEngine` (the AGPL core) directly, so it carries an AGPL header
honestly, matching what it actually invokes -- see `../LICENSE_COMMERCIAL_PLACEHOLDER.md`.

Run: python3 "ProofRay Engine/examples/quickstart.py"
"""
